...
A user-friendly PySide6-based graphical interface for creating professional EMG plots from CSV data files. Designed specifically for researchers using MonStim Analysis software, this GUI makes it easy to generate publication-quality EMG visualizations without writing code.
...
- **Framework**: PySide6 for cross-platform GUI
